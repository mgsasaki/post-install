...
sudo curl \
    -L "https://github.com/docker/compose/releases/download/${docker-compose-version}/docker-compose-$(uname -s)-$(uname -m)" \
    -o /usr/local/bin/docker-compose

# Apply executable permissions to the binary:
sudo chmod +x /usr/local/bin/docker-compose

# Install line completion (https://docs.docker.com/compose/completion)
# Bash:
sudo curl \
    -L "https://raw.githubusercontent.com/docker/compose/${docker-compose-version}/contrib/completion/bash/docker-compose" \
    -o /etc/bash_completion.d/docker-compose

# Reload your setting in your current terminal:
source ~/.bashrc
